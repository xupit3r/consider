...
- `.gemini/skills/causal-discovery-expert/references/alvgl_decomposition.md`: Mathematical formulation and Neanderthal implementation strategy.
...
4. **Use the nREPL Server**: Leverage the `clojure_eval` tool to inspect ALVGL decomposition results, verify acyclicity scores ($h(W)$), and test SVT logic. The server is typically available on port 7888.
