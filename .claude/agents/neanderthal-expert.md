...
- `.gemini/skills/neanderthal-expert/references/performance_patterns.md`: In-place operations, backend selection, and element-wise math.
- `.gemini/skills/neanderthal-expert/references/memory_management.md`: dtype-next interop, off-heap release, and avoiding JVM boxing.
...
4. **Use the nREPL Server**: Leverage the `clojure_eval` tool to verify Neanderthal operations in real-time. The server is typically available on port 7888.
