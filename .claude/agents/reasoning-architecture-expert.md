...
- `.gemini/skills/reasoning-architecture-expert/references/mcts_fot_patterns.md`: UCT formulas, FoT patterns, and policy selection workflows.
...
4. **Use the nREPL Server**: Leverage the `clojure_eval` tool to inspect the MCTS tree structure, verify UCT scores, and test candidate expansion logic. The server is typically available on port 7888.
